...
WHERE localidad.nombreLocalidad='Cordoba'
...
else
{
    ...
    <?php while($row = mysql_fetch_assoc($resultado))
    	  {  ?>
			...
			<td><img src="imagen/<?php echo ($row['imagen']); ?>" width="150" height="150" alt="Imagen propiedad Córdoba" 
				title="Imagen propiedad Córdoba" /></td>
			</tr>
   <?php  } ?>
      		</tbody>
      	</table>
	...
	if($num_rows != 0)
	{
	   ...
	   ?><ul id="pagination-digg"><?php
		 ...
		 <?php
			  ...
			  {?>
			  	<li><a href="Cordoba.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
		<?php }
	      
	       //Y SI LA ULTIMA PÁGINA ES MAYOR QUE LA ACTUAL MUESTRO EL BOTON NEXT O LO DESHABILITO
			if($lastpage >$page )
			{?>		
		    	<li class="next"><a href="Cordoba.php?page=<?php echo $nextpage;?>" >Siguiente &raquo;</a></li><?php
			}
			else
			{?>
		...
		?>
		 	<li class="previous"><a href="Cordoba.php?page=<?php echo $prevpage;?>">&laquo; Anterior</a></li><?php
			...
			?>		<li class="active"><?php echo $i;?></li><?php
				...
				{
			?>		<li><a href="Cordoba.php?page=<?php echo $i;?>" ><?php echo $i;?></a></li><?php
				}
			}
