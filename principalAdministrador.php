...
<div id="header">
		...
		echo "Bienvenido: ".$_SESSION['admin'];
		  ...
		  <a href="principalAdministrador.php"><img class="logo" src="imagen/logo.jpg" alt="Imagen Logo" 
				title="Imagen Logo" /></a>
...
<tr>
	<td align="left" width="314">
		<div id="bljaIMGte">
		<a href="#"><img  onmouseover="this.src='imagen/casas.jpg';" onmouseout="this.src='imagen/casas.jpg';"
	...
	<td align="center" width="314">
		<div id="bljaIMGte2">
		<a href="#"><img onmouseover="this.src='imagen/deptos.jpg';" onmouseout="this.src='imagen/deptos.jpg';"
	...
	<td align="right" width="314">
		<div id="bljaIMGte3">
		<a href="#"><img onmouseover="this.src='imagen/terrenos.jpg';" onmouseout="this.src='imagen/terrenos.jpg';"
