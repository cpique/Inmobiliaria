...
<div id="header">
		...
		echo "Bienvenido: ".$_SESSION['usuario'];
		  ...
		  <a href="index.php"><img class="logo" src="imagen/logo.jpg" alt="Imagen Logo" title="Logo de la página" /></a>
            <?php } ?>
...
WHERE tipo.descripcionTipo='Terreno'
...
<td><b>Imagen</b></td>
    ...
    <?php while($row =  mysql_fetch_assoc($resultado))
    	  {  ?>
			...
			<td><img src="imagen/<?php echo ($row['imagen']); ?>" width="150" height="150" alt="Imagen terreno" 
				title="Imagen terreno" /></td>
	...
	if($num_rows != 0)
	{
	   ...
	   ?><ul id="pagination-digg"><?php
		 ...
		 <?php
			  ...
			  {?>
			  	<li><a href="terrenos.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
		<?php }
	      
	       //Y SI LA ULTIMA PÁGINA ES MAYOR QUE LA ACTUAL MUESTRO EL BOTON NEXT O LO DESHABILITO
			if($lastpage >$page )
			{?>		
		    	<li class="next"><a href="terrenos.php?page=<?php echo $nextpage;?>" >Siguiente &raquo;</a></li><?php
			}
			else
			{?>
		...
		?>
		 	<li class="previous"><a href="terrenos.php?page=<?php echo $prevpage;?>">&laquo; Anterior</a></li><?php
			...
			?>		<li class="active"><?php echo $i;?></li><?php
				...
				{
			?>		<li><a href="terrenos.php?page=<?php echo $i;?>" ><?php echo $i;?></a></li><?php
				}
			}
